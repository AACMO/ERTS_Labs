...
// Exercise 2: Controlling fan speed with ultrasound sensor reading
...
#define ARDUINO_P       1                         // Variable to decide which is the IDE used for the programming and for the testing
